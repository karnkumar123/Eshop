...
let DataServiceService = class DataServiceService {
    ...
    getItems() {
        let getURL = 'shops/items';
        return this._http.get(getURL);
    }
    addShoppingItem(newItem) {
        let postURL = 'shops/item';
    ...
    deleteItem(id) {
        let deleteURL = '/shops/item';
        return this._http.delete(`${deleteURL}/${id}`);
    }
    updateItem(id, data) {
        let updateURL = 'shops/item';
        let header = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        header.append('Content-Type', 'application/json');
...
let ShoppingItemComponent = class ShoppingItemComponent {
    ...
    deleteItem(itemId) {
        this._dataService.deleteItem(itemId).subscribe((response) => {
            this.getItems();
        });
    }
    addItem(itemName, itemQuantity) {
        ...
        this._dataService.addShoppingItem({ itemName: itemName.value, itemQuantity: itemQuantity.value, itemBought }).subscribe((data) => {
            this.getItems();
        });
    }
    update(id) {
    ...
    updateItem(itemName, itemQuantity) {
        let updateObj = { itemName: itemName['value'], itemQuantity: itemQuantity['value'] };
        this._dataService.updateItem(this.updateId, updateObj).subscribe((data) => {
            console.log(data);
            this.getItems();
        });
    }
};
ShoppingItemComponent.ctorParameters = () => [
